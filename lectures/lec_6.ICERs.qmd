...
-   $C_0$: net present value of total lifetime costs of comparator
-   $E_1$: effectiveness of new treatment
-   $E_0$: effectiveness of comparator
    -   [Effectivness is measured in expected life expectancy,
        quality-adjusted life years (QALYs) or disability-adjusted life
        years (DALYs), or some decision-relevant health
        outcome.]{style="font-size: 2vh"}

[Most often used, since for most conditions there is already some
available treatment.]{.bold .accent-text}
::::
...
## Neurologic Disease Decision Tree {.title-photo-slide}

::: photo-container
![](images/lec6/Neurologic.png)
:::
...
:::::: concept-grid
::: concept-box
$C_{treat}$ = [expected cost of treat everyone strategy.]{.db-text}
:::

::: concept-box
$C_{no treat}$ = [expected cost of treat *no one* strategy.]{.db-text}
:::

::: concept-box
$C_{biopsy}$ = [expected cost of biopsy strategy.]{.db-text}
:::
::::::

:::::: {.concept-grid .fragment}
::: {.concept-box .accent}
$E_{treat}$ = [expected life expectancy of treat everyone
strategy.]{.db-text}
:::

::: {.concept-box .accent}
$E_{no treat}$ = [expected expectancy of treat *no one*
strategy.]{.db-text}
:::

::: {.concept-box .accent}
$E_{biopsy}$ = [expected expectancy of biopsy strategy.]{.db-text}
:::
::::::

## Outcomes in Amua

![](images/lec6/outcomes-amua.png){fig-align="center"}

## Strategy: Treat No One

![](images/lec6/NoTreatOutcomes.png)

## Strategy: Treat All

![](images/lec6/TreatOutcomes.png)

## Key Takeaways (For Now)

::: {.incremental .icon-bullets}
-   Treatment yields *higher* life expectancy for those with disease,
    but comes at a cost. (↑ LE, ↑ Cost)
-   Treatment yields *lower* life expectancy for those without the
    disease, *and also* comes at a cost. (↓ LE, ↑ Cost)
...
-   Programs are then selected from the LEAST to the MOST expensive
    until the budget is expended

-   Final array of programs selected will depend on the budget
    constraint
:::
::::::
:::::::
...
## (2c) Identify Dominated Strategies {.smaller auto-animate="true"}
