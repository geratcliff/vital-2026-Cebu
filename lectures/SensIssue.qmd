...
To complete a OWSA, the model needs to have some method of "knowing" what to do with the difference between the original variable and the sensitivity variable.
...
::: {.column width="45%"}
If a probability is 0.4 in the model and then run on 0.6 in the OWSA, what probability is now 0.2 lower?
:::
...
::: {.column width="45%"}
If a probability is 0.4 in the model and then run on 0.3 in the OWSA, what probability is now 0.1 higher?
:::
::::::
:::::::
::::::::
