...
parameters <- read.csv(here::here("lectures/gompertz-mortality.csv"))
```

## Background Mortality

::: incremental
-   You can fit a Gompertz survival model to each age's life table data.[^9]
...
[^9]: See the [workshop blog posting](../blog/posts/gompertz-mortality.html) for R code!
