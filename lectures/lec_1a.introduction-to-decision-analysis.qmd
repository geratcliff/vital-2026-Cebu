...
-   Governments/society's cannot afford all the healthcare from which people could possibly benefit
-   Either implicitly or explicitly, we make choices about which programs to fund, which individuals and populations to screen, and which expensive new drugs to provide to which patients
-   ***Decision Analysis can help us ensure that we prioritize the highest value care possible at an efficient price point (in other words, how to get the biggest bang for your buck)**
...
<br>
> If we only consider benefits when we define value, it's no different htan efficacy or effectiveness research. And we obviously don't want to just consider costs without benefits! 
...
## Ex 3. Another "competing objectives" example: My own work 

**Opioid/substance use in pregnancy**

![](images/ex4-oud-tradeoffs.png)


## Ex 3. Opioid/substance use in pregnancy 

![](images/oud-schematic-2.png)


## Ex 3. Opioid/substance use in pregnancy 

![](images/oud-methods.png)
...
-   We can also see that our final conclusions are driven by the infant outcomes 
...
> Despite that challenging decision trade-off, the model clearly demonstrated that even if buprenorphine is “dominating” in the parlance of decision-science and health economics, if providers and/or policy makers require pregnant individuals to initiate treatment with the “optimal” treatment, and that requirement leads to decreased retention on MOUD, then the policy becomes a poor one that results in less life and higher cost than allowing pregnant individuals to choose their preferred CHOICE. 
