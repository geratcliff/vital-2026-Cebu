...
-   [Might inadvertently capture time preference (i.e., we might value
    ...
    fragment-index="2"}
-   [Risk posture]{.fragment fragment-index="3"}[is NOT]{.bold} captured
...
E1 = 0.07 years E2 = 0.10 years C1 = 1,500 C2 = 2,800 λ = 50,000 per
year of life saved

ICER=2800−15000.10−0.07=43,333

## Example: NHB

NHB1=0.07−1500/50000=0.040NHB2=0.10−2800/50000=0.044Incremental
NHB=0.044−0.040=0.004
...
NMB1=0.07×50000−1500=2000NMB2=0.10×50000−2800=2200Incremental
NMB=2200−2000=200 - Quantifies this improvement’s value in monetary
...
option, given a specified WTP threshold. A higher NHB means more health
gained after accounting for costs.
