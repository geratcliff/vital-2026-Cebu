...
-   Some bad events may look “good” in a model because they cost
        less. (For example, **death has low cost**, but it is clearly a bad outcome.)
...
**stroke** for the rest of your life\] and live the rest of your life in
...
## Alternatives to ICERs{.section-slide}
...
-   Treatment 2 provides \$200 more net value than Treatment 1 after accounting for
...
<li> Clinical outcomes should be clearly defined and relevant to the decision question.</li>

<li>QALYs combine quantity and quality of life into a single summary measure, enabling comparisons.</li>

<li>Net benefit approaches provide alternatives to ICERs but require an explicit willingness‑to‑pay threshold.</li>
...
::: next-info
Next Lecture: <strong>DALYs</strong>
:::
