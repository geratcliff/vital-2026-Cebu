...
## 3a. Define the Markov Cycle Length {.small}
...
## 3. Parameterize the Model {.small}
...
-   Constructing the matrix is a fairly technical, but fairly
    ...
    -   We will skip over this process for now, but come back to it tomorrow!
...
## Transition Probability Matrix {.small data-visibility="hidden"}
