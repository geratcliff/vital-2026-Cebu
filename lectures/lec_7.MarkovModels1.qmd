...
library(here)
library(gt)
source(here::here("/Users/ratclg2/Documents/lectures/_healthy-sick-dead/01-healthy-sick-dead_setup.r"))
source(here("/Users/ratclg2/Documents/lectures/_healthy-sick-dead/functions_healthy-sick-dead.r"))
source(here("/Users/ratclg2/Documents/lectures/_healthy-sick-dead/02_healthy-sick-dead_process-parameters.r"))
source(here("/Users/ratclg2/Documents/lectures/_healthy-sick-dead/04_healthy-sick-dead_discounting-and-cycle-adjustments.r"))
source(here("/Users/ratclg2/Documents/lectures/_healthy-sick-dead/05_healthy-sick-dead_construct-transition-probability-matrices.r"))
```
...
## Modeling a Simple Disease Process {.section-slide}
::: section-number
01
:::
...
Remaining healthy carries no utility decrement <br>(utility weight = 1.0
...
::: {.cons-column .incremental}
<div class="column-title">Disadvantages</div>

- Difficult to include clinical detail
- Elapse of time is not readily evident.
- Difficult to model longer (\>1 cycle) time horizons
:::
:::
...
##  When choosing a model structure... {.quote-slide}
...
## Constructing a Markov Model {.section-slide}
::: section-number
03
:::
...
# 1. Define the Decision Problem {.accent-text}
...
# 2. Conceptualize the Markov Model {.accent-text}
...
![](/images/lec7/bubble.png)

::: footer
Diagram constructed using the [Health State Transition Diagram Builder](https://geratcliff.shinyapps.io/bubble_tool/){target="_blank"}
:::
...
::: fragment
![](images/lec7/cyclelength1.png)
:::

::: fragment
![](images/lec7/cyclelength2.png){.fragement}
:::

::: fragment
![](images/lec7/cyclelength3.png)
:::

::: fragment
![](images/lec7/cyclelength4.png)
:::

::: fragment
![](images/lec7/cyclelength5.png)
:::
