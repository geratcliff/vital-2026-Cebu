...
::: example-text
On average, patients given Treatment A will live 0.30 years longer than
...
When the probability of rain is 50% at BOTH the beach and home, givenhow
...
## Probability Review {.section-slide}
...
occurring is the **sum of the probability of each event occurring
individually**
