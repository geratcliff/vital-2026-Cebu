...
::: arrow-bullets {style="line-height:1.1"}
...
::: {.column width="45%" style="display:flex; align-items:center; justify-content:center;"}
```{dot}
//| fig-align: center
//| fig-width: 4
//| fig-cap: Compound transition patterns under standard conversion
//| label: fig-comp-st
digraph G {
  layout = neato;
