...
## Link in Github repo
download_link(
  link = "https://geratcliff.github.io/vital-2026-Cebu/case-studies/parameters_markovsimp.csv",
  button_label = "Download Parameters",
  button_type = "primary",
  has_icon = TRUE,
  icon = "fa fa-save",
...
| rr_treated     | 0.5        | Risk reduction of getting Disease X after treated |
...
## Link in Github repo
download_link(
  link = "https://geratcliff.github.io/vital-2026-Cebu/case-studies/tbl_p_die.csv",
  button_label = "Probability of Death By Age",
  button_type = "primary",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
...
![](images/simpleMarkov/TreatNoneFull.png)
...
<br> What is the ICER (to two decimal places) of the strategy you would choose? <br> <input id="answersimp" type="number" step="0.01" placeholder="e.g., 43.5" /> <button id="checksimp">Check</button>
...
## Link in Github repo
download_link(
  link = "https://geratcliff.github.io/vital-2026-Cebu/case-studies/MarkovSimpleWithScreening.amua",
  button_label = "Amua File With Screening Added",
  button_type = "primary",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
