...
<br> Enter the ICER of the strategy you would choose (to two decimal places) <br> <input id="answercea1" type="number" step="0.01" placeholder="e.g., 43.5" /> <button id="checkcea1">Check</button>

::: {#feedbackcea1 style="margin-top: 10px;"}
:::
...
Enter your result: <input id="answercea2" type="number" step="0.01" placeholder="e.g., 42.5" /> <button id="checkcea2">Check</button>
...
Enter your result: <input id="answercea3" type="number" step="0.01" placeholder="e.g., 42.5" /> <button id="checkcea3">Check</button>

```{=html}
<script>
(function() {
  // Set the correct value and tolerance
  const CORRECT = 104565.22;
  const TOL = 0.01; // accept +/- 0.01
...
[Answer Key](case-studies/CaseStudy_CEA_Ans.html)
