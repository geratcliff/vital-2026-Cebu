...
This is the initial structure of the model that we will build everything
from.

You can build it out or download the following document:
[tree_initial.amua](tree_initial.amua)
...
1\. Click next to the grey "p:" under the branch that you want to edit
...
| Label       | Value    | Description                      |
|-------------|----------|----------------------------------|
| c_untreated | \$35,000 | Cost of being sick and untreated |
| c_treated   | \$30,000 | Cost of being treated            |
| c_screen    | \$2,510  | Cost of screening                |

### Life Years

| Label | Value | Description |
|-------------------|-----------------|-------------------------------------|
| LY_untreated | 8 | Additional Life Years Gained of being sick and untreated |
| LY_treated | 17 | Additional Life Years Gained of being sick and treated |
| LY_healthy | 20 | Additional Life Years Gained of screening |
| LY_healthy_treated | 19.7 | Additional Life Years Gained to implement screening |
:::
...
![](images/tree/AddOutcomeParameters.png)
...
3.  The "Cost" outcome is likely already added. If not, click the blue
    plus sign ![](/amua-images/add_16.png) . This will add a new row to
    the outcomes table
