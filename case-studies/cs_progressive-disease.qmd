...
Note that in Panel B, the probability of Event B is rescaled by $(1-p_A)$. This ensures that the probability of Event B is only among those who survive Event A (i.e., one minus the probability of Event A).

If you are converting death rates to probabilities using standard formulas (e.g., $1-\exp(-r)$) you should use a sequential approach where only two events are considered at at time (Panel B). This ensures that the converted probabilities work correctly. You must, however, re-scale all "downstream" probabilities so that they are conditional on not experiencing earlier events.
...
![](images/clipboard-1329716395.png)
...
![](images/clipboard-1585004494.png)
...
![](images/clipboard-3029162401.png){fig-align="center" width="500"}
...
![](images/clipboard-4138220920.png)
