...
-   Add a more explicit download link.
- Add final case study template to AWS instance landing page. 
-   Mention initial age
-   Change initial parameters in blank doc to align with final values.
-   Have them change cohort size to 1 for the life expectancy check.
-   Two-prongs not three.
-   Do discounting only after QALY and cost outcomes have been defined.
...
![](images/clipboard-1008495585.png)
