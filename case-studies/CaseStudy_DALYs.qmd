...
3.  Calculate Years Lived with Disability (YLDs) using disability weights

4.  Calculate Years of Life Lost (YLLs) with proper discounting from time of death

5.  Combine YLDs and YLLs to compute total DALYs for cost-effectiveness analysis
:::
...
**To save time, we will go back to the simple Markov Model**
...
| dw_sick_treated | 0.10  | Disability weight for Sicker health state. |
