...
2.  Collecting data using the [data collection tool](https://geratcliff.shinyapps.io/shinyapp_data/){target="_blank"} \[Due January 8\]

    -   Data Collection Survey that will sent to your email to collect your progress
    
3.  Knowledge baseline that will sent to your email before the workshop \[Due January 16\]

4.  Download AMUA \[Due January 16\]
...
**S.I.F.T Method** <https://hapgood.us/2019/06/19/sift-the-four-moves/>{target="_blank"}
...
-   Slide 3: Research Question using PICOT
